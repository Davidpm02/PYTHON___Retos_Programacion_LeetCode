...
class Solution:
    def constructDistancedSequence(self, n: int) -> List[int]:
        ...
        """
        Retorna la secuencia lexicográfica más larga que se puede 
        formar a partir de números comprendidos en el rango [1, n].

        Las soluciones cumplen:
            - El entero 1 solo puede aparecer una vez en cada respuesta.
            - Cada entero en el rango [2, n] aparece dos veces en cada
              respuesta.
            - Para cada entero i en el rango [2, n], debe existir una 
              distancia exacta de i entre cada repetición.
        ...
        # Solución O(1) para los casos límites del reto (1 <= n <= 20)
        sets_solutions = [
            [1],
            [2,1,2],
            [3,1,2,3,2],
